  ...
  return (
    <div className="min-h-screen flex flex-col bg-bg-primary text-white">
      <div className="flex-1 flex flex-col items-center justify-center text-center gap-6 p-16 md:p-8 animate-[slide-up_0.6s_ease-out]">
        ...
        <h2 className="text-4xl md:text-2xl font-bold uppercase tracking-wide font-mono">OBO Financial Agent</h2>
        <p className="text-base text-text-secondary font-mono uppercase tracking-wide">Sign in to shop and purchase with your AI agent</p>
        <button
