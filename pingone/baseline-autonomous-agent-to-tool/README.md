...
Deploying from an Apple Silicon Mac requires no extra steps — the Makefiles build `--platform linux/amd64` and the agent venv targets Python 3.13 (`brew install python@3.13` if absent).
